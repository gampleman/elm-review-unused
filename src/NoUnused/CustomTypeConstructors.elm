                                ...
                                |> List.map
                                    (\constructorName ->
                                        errorForModule
                                            ...
                                            , wasUsedInComparison = Set.member ( moduleName, Node.value constructorName ) projectContext.wasUsedInComparisons
                                            }
                                            constructorName
                                    )
                        )
...
errorInformation : { wasUsedInLocationThatNeedsItself : Bool, wasUsedInComparison : Bool } -> String -> { message : String, details : List String }
errorInformation { wasUsedInLocationThatNeedsItself, wasUsedInComparison } name =
    ...
    , details =
        ...
        , ( "I found it used in comparisons, but since it is never created anywhere, all of those can be evaluated to False (for (==), True for (/=)).", wasUsedInComparison )
        ]
...
errorForModule : Rule.ModuleKey -> { wasUsedInLocationThatNeedsItself : Bool, wasUsedInComparison : Bool } -> Node String -> Error scope
